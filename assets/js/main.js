(function ($) {
  ...
  var bgsSelector = $(".bg-imgs");
  var images = $(".bg-imgs").data("bgs");
  ...
  $(function () {
    if (typeof images !== 'undefined') {
      if (images.length > 0) {
        var i = 0;
        bgsSelector.css("background-image", "url(" + images[i] + ")");
        setInterval(function () {
          i++;
          if (i == images.length) {
            i = 0;
          }
          bgsSelector.fadeOut("slow", function () {
  ...
  $(document).ready(function () {
    ...
    var swiper = new Swiper('.feature-background-slider__container', {
      slidesPerView: 1,
      spaceBetween: 30,
      loop: true,
      lazy: true,
